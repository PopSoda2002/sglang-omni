...
Mirrors :class:`sglang_omni_v1.models.fishaudio_s2_pro.fish_scheduler.FishScheduler`
in spirit but uses Higgs-specific finish semantics: the V0 sampler's
``generation_done`` flag (set after wind-down) is authoritative; ``max_new_tokens``
acts as a defensive cap.
"""
