...
from sglang_omni_v1.models.higgs_tts.delay_pattern import (
    apply_delay_pattern,
    reverse_delay_pattern,
)
from sglang_omni_v1.models.higgs_tts.payload_types import HiggsTtsState
from sglang_omni_v1.models.higgs_tts.tokenizer import HiggsTokenizerAdapter
...
def _get_or_load_codec(path: str, device: str, dtype: str) -> Any:
    from sglang_omni_v1.models.higgs_tts.audio_codec import HiggsAudioCodec
...
def _load_audio_to_24k(reference_audio: Any) -> tuple[np.ndarray, int] | None:
    ...
    from sglang_omni_v1.models.higgs_tts.audio_codec import HiggsAudioCodec
    from sglang_omni_v1.preprocessing.audio import AudioMediaIO
...
def create_audio_encoder_executor(
    ...
    *,
    ...
    """
    from sglang_omni_v1.models.higgs_tts.bootstrap import (
    ...
    def _encode(payload: StagePayload) -> StagePayload:
        ...
        # Serialise as nested float list so the cross-process relay
        # preserves bf16 values exactly (bf16 → fp32 → fp64 → fp32 → bf16
        # round-trip is bit-perfect).
...
def create_sglang_tts_engine_executor(
    ...
    *,
    ...
    from sglang_omni_v1.models.higgs_tts.bootstrap import register_higgs_tts_in_sglang
    from sglang_omni_v1.models.higgs_tts.higgs_scheduler import HiggsScheduler
    from sglang_omni_v1.models.higgs_tts.model_runner import HiggsTTSModelRunner
    from sglang_omni_v1.models.higgs_tts.request_builders import (
