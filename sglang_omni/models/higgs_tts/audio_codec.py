...
# Bundled codec config. The TTS ckpt's own ``config.json`` describes the
# TTS model, not the codec — we ship the codec schema beside the vendored
    ...
    def from_tts_ckpt(
        ...
        *,
        ...
        Args:
            ...
            codec_config_path: Optional override for the codec architecture
                config. Defaults to the bundled
                ``higgs_audio_v2_tokenizer_config.json``.
        """
