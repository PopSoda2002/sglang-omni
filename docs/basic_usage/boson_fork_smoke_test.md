...
This note records the smoke test used to verify the `boson-ai/sglang-omni` fork against
...
- Full S2-Pro usage guide: [tts_s2pro.md](tts_s2pro.md)
- Fork upstream reference: [sgl-project/sglang-omni](https://github.com/sgl-project/sglang-omni)
